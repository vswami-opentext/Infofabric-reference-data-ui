...
export class MainServiceService {
  ...
  getPermissions(data) {
    ...
    this.http.get('/api/check').subscribe(data => {
  ...
  fetchTenant(){
    ...
    return this.http.get('/api/datamodel');
  ...
  getFilteredRecords(data,filter){
  ...
  getRecords(payload){
    ...
    if(payload.type == 'client'){
      ...
      return {"count":3,"results":[{"name":"Axis 360","id":"1"},{"name":"Client B","id":"2"},{"name":"IRT","id":"5"}]};
    }
  }
