...
var DomHandler = /** @class */ (function () {
    ...
    DomHandler.prototype.relativePosition = function (element, target, fixtop) {
        ...
        var top, left;
        if (fixtop || (targetOffset.top + targetHeight + elementDimensions.height) > viewport.height) {
    ...
    DomHandler.prototype.scrollPSInView = function (container, item) {
        var borderTopValue = getComputedStyle(container).getPropertyValue('borderTopWidth');
        var borderTop = borderTopValue ? parseFloat(borderTopValue) : 0;
        var paddingTopValue = getComputedStyle(container).getPropertyValue('paddingTop');
        var paddingTop = paddingTopValue ? parseFloat(paddingTopValue) : 0;
    ...
    DomHandler.prototype.visible = function (element) {
        return element.offsetWidth > 0 && element.offsetHeight > 0;
    };
    DomHandler.prototype.getStyle = function (el, styleProp) {
    ...
    DomHandler.prototype.isHidden = function (element) {
