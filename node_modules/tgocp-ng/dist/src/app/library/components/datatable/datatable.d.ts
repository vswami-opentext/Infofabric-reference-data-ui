...
export declare class ScrollableView implements AfterViewInit, AfterViewChecked, OnDestroy {
    ...
    scrollToTopSubscriptionRef: any;
...
export interface DataTableLocaleSettings {
    emptyMessage?: string;
}
export declare class DataTable implements AfterViewChecked, AfterViewInit, AfterContentInit, OnInit, OnDestroy, BlockableUI {
    ...
    rowDragging: boolean;
    _locale: DataTableLocaleSettings;
    _language: string;
    ...
    checkFirstSortableColumn(): boolean;
    ...
    _filter(): void;
    hasFilter(): any;
    onFilterInputClick(event: any, column: Column): void;
    filterConstraints: {
...
export declare class ReorderableRow implements AfterViewInit {
    ...
    dragLeaveListener: any;
    dropListener: any;
    constructor(dt: DataTable, el: ElementRef, zone: NgZone);
    ngAfterViewInit(): void;
    bindEvents(): void;
    unbindEvents(): void;
