 ...
 */
export declare class OtCarousel implements AfterContentChecked, AfterContentInit, OnDestroy {
    private _platformId;
    private _ngZone;
    private _cd;
    ...
    constructor(config: OTCarouselConfig, _platformId: any, _ngZone: NgZone, _cd: ChangeDetectorRef);
    mouseEnter(): void;
    mouseLeave(): void;
...
export declare const OT_CAROUSEL_DIRECTIVES: (typeof NgbSlide | typeof OtCarousel)[];
