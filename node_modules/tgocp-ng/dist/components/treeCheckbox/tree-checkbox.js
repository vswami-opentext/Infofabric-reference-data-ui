...
import { NgModule, Component, Input, Output, EventEmitter, ContentChildren, QueryList, Inject, ElementRef, forwardRef } from '@angular/core';
...
var UITreeNode = /** @class */ (function () {
    ...
    var UITreeNode_1;
    UITreeNode.ICON_CLASS = 'ot-ui-treenode-icon ';
    __decorate([
        Input(),
...
var Tree = /** @class */ (function () {
    ...
    Tree.prototype.onNodeClick = function (event, node) {
        if (!node.isHeading) {
            ...
            if (eventTarget.className && eventTarget.className.indexOf('ot-ui-tree-toggler') === 0) {
                return;
            }
    ...
    Tree.prototype.propagateUp = function (node, select) {
        if (node.children && node.children.length) {
            ...
            if (select && selectedCount == node.children.length) {
                // this.selection = [...this.selection||[],node];   // @Rishabh - commeting as I dont wan't parent node selected in GPD :)
    ...
    Tree = __decorate([
        ...
        __param(1, Optional()),
        __metadata("design:paramtypes", [ElementRef, TreeDragDropService])
    ], Tree);
    return Tree;
}());
export { Tree };
var TreeCheckboxModule = /** @class */ (function () {
    function TreeCheckboxModule() {
    }
    TreeCheckboxModule = __decorate([
        NgModule({
    ...
    return TreeCheckboxModule;
}());
export { TreeCheckboxModule };
//# sourceMappingURL=tree-checkbox.js.map